    ...
    <Layout>
      <main className="screen-container container mx-auto max-w-screen-xl gap-12 pt-3">
        <div className="no-print">
          <div className="absolute top-0 right-10 sm:right-28">
            <div
              className="flex w-10 cursor-pointer flex-col items-center pt-3 pb-3 hover:bg-blue-100 sm:w-14 sm:pb-0 sm:text-xl"
          ...
          <div
            className="absolute top-0 right-14 hidden sm:block"
          ...
          >
            <div className="flex w-10 cursor-pointer flex-col items-center pt-3 pb-3 hover:bg-blue-100 sm:w-14 sm:pb-0 sm:text-xl">
              {props.login ? "🔓" : "🗝️"}
              <div className="hidden text-center text-gray-500 text-xxs sm:block">
        ...
        <div className="no-print mb-10 flex justify-center">
          {props.login ? (
            <button
              type="button"
              className="mr-1 mb-1 rounded-md border border-red-700 px-5 py-2.5 text-center font-medium text-red-700 text-sm hover:bg-red-800 hover:text-white focus:outline-none focus:ring-2 focus:ring-red-300 dark:border-red-500 dark:text-red-500 dark:focus:ring-red-800 dark:hover:bg-red-500 dark:hover:text-white"
