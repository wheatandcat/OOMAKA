  ...
  return (
    <div className="container mx-auto px-4 ">
      ...
      <main className="my-5">
        <div>
          <h1>利用規約</h1>
          <div className="mb-4 text-[0.75rem]">
            この利用規約（以下、「本規約」といいます。）は、合同会社UNICORN（以下、「当社」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
          </div>
          <h2>第1条（適用）</h2>
          <ol>
            <li>
